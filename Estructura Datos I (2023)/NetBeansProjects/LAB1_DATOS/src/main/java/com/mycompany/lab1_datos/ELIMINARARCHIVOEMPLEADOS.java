 ...
 */
public class ELIMINARARCHIVOEMPLEADOS extends javax.swing.JFrame {

    /**
     * Creates new form ELIMINARARCHIVOEMPLEADOS
     */
    public ELIMINARARCHIVOEMPLEADOS() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Eliminar Registro en Empleados:");
    ...
    String rutaEmpleadosACT = "C:/Users/LENOVO V14-G2/Documents/labo1/EmpleadosACT.csv";
    ...
    if (opcion == JOptionPane.YES_OPTION) {
        ...
        try {
            File archivoEntrada = new File(rutaEmpleados);
            File archivoSalida = new File(rutaEmpleadosACT);

            BufferedReader br = new BufferedReader(new FileReader(rutaEmpleados));
            PrintWriter pw = new PrintWriter(new FileWriter(rutaEmpleadosACT));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ELIMINARARCHIVOEMPLEADOS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
